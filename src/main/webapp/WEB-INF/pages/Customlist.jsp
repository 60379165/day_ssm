...
<head>
    ...
    <script type="text/javascript">
        ...
        function replaceDoc()
        {
            window.location.replace("http://localhost:8080/day_ssm_war_exploded/custom/findAll")
        }
    </script>
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form class="navbar-form navbar-left" action="../custom/findbyname" method="post">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="../addCustom.jsp">添加信息</a></li>
                    <li class="dropdown">
                        <a href="../#">注销</a>
...
<%--    <a class="btn btn-primary" href="${pageContext.request.contextPath}/addCustom.jsp">添加租客信息</a>--%>
...
<%--</div>--%>
<form  id="form" action="../custom/deleteAll" method="post">
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${list}" var="a" varStatus="s">
            <tr>
                ...
                <td>${a.sex}</td>
                <td> ${a.hid}</td>
                <td><a href="../custom/delete/${a.cid}">删除</a>
                    <a href="../custom/findbyid/${a.cid}">修改</a></td>
            </tr>
        </c:forEach>

...
<head>
    ...
    <script type="text/javascript">
        ...
        function replaceDoc()
        {
            window.location.replace("http://localhost:8080/day_ssm_war_exploded/custom/findAll2")
        }
    </script>
...
<div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li className=""><a class="active" href="javascript:void(0);">租户管理</a></li>
                    ...
                    <form class="navbar-form navbar-left" action="../custom/findbyname2" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" name="search" placeholder="输入租户姓名">
                        </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../saddCustom.jsp">添加信息</a></li>
                        <li class="dropdown">
                            <a href="../#">注销</a>
    ...
    <h1 style="text-align: center">租户信息列表</h1>
<%--    <div style="float: right;margin: 5px;">--%>
<%--        <a class="btn btn-primary" href="${pageContext.request.contextPath}/saddCustom.jsp">添加租客信息</a>--%>
...
<%--    </div>--%>
    <form id="form" action="../custom/deleteAll2" method="post">
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${list}" var="a" varStatus="s">
                <tr>
                    <td><input type="checkbox" name="hid" value="${a.cid}"></td>
                    <td>${s.count}</td>
                    <td> ${a.name}</td>
                    <td>${a.phone}</td>
                    <td>${a.sex}</td>
                    <td> ${a.hid}</td>
                    <td><a href="../custom/delete2/${a.cid}">删除</a>
                        <a href="../custom/findbyid2/${a.cid}">修改</a></td>
                </tr>
            </c:forEach>
